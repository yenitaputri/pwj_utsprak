  ...
  <div class="container">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
        <div class="col-lg-5 d-none d-lg-block bg-register-image" style="background-image: url('{{ asset('https://i.pinimg.com/564x/a7/b8/bb/a7b8bbf0a82d4b7703304704001372f3.jpg') }}');"></div>
          <div class="col-lg-7">
            <div class="p-5">
